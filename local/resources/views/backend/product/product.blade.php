...
<div class="page-header card">
    <div class="card-block front-icon-breadcrumb">
        <h5 class="m-b-10">{{ $productcollection->collection_name_en }}</h5>
...
<div id="content" class="content">
    ...
    <div class="card">
        <div class="card-header">
            <h5>{{ $productcollection->collection_name_en }}</h5>
                ...
                <table id="example1" class="table table-bordered">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td style="text-align: center; vertical-align: middle;">{{$item->product_name_en}} </td>
                            ...
                            <td style="text-align: center;">
                                <a href="{{route('product.edit',$item->product_id )}}" class="btn btn-mat btn-warning"><i
                                        class="fa fa-edit"></i> Edit</a>
                                <button type="button" class="btn btn-danger"
                                    onclick="del({{$item->product_id   }})"><i class="fa fa-trash-o"></i> Delete </button>
                            </td>
                        </tr>
                        @endforeach
                    </tbody>
    ...
    <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h4 class="modal-title">Add {{ $productcollection->collection_name_en }}</h4>
                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                    <span aria-hidden="true">&times;</span>
                </button>
            </div>
            <div class="modal-body">
                <form action="{{route('product.store')}}" id="main-contractor" method="POST"
                    enctype="multipart/form-data">
                    @csrf
                        <input type="hidden" name="product_type" value="{{ $productcollection->type_id }}">
                        <input type="hidden" name="product_collection" value="{{ $productcollection->collection_id }}">
                        ...
                        {{-- <div class="col-md-12">
                            <div class="form-group">
                                ...
                                <textarea class="form-control summernote" type="text" name="product_features_th" rows="3"
                                    placeholder="Enter Content"></textarea>
                            </div>
                        </div> --}}
                        ...
                        {{-- <div class="col-md-12">
                            <div class="form-group">
                                <strong>Features</strong>
                                <textarea class="form-control summernote" type="text" name="product_features_en" rows="3"
                                    placeholder="Enter Content"></textarea>
                            </div>
                        </div> --}}
                    ...
                    <div class="form-group row">
                        <label class="col-sm-2 col-form-label"></label>
                        <div class="col-sm-12">
                            <input type="file" class="form-control" name="fileimg[]" accept="image/*" multiple required>
