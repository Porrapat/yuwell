<nav class="pcoded-navbar">
    ...
    <div class="pcoded-inner-navbar main-menu ">
        <div class="pcoded-navigation-label">Blackoffice</div>
        <ul class="pcoded-item pcoded-left-item">
            ...
            <li class="pcoded-hasmenu">
                <a href="javascript:void(0)">
                    <span class="pcoded-micon"><i class="ti-home"></i><b>D</b></span>
                    <span class="pcoded-mtext">Intoduction</span>
                    <span class="pcoded-mcaret"></span>
                </a>
                <ul class="pcoded-submenu">
                    <li class="">
                    ...
                    <li class=" ">
                        <a href="{{ url('/admin/overview') }}">
                            <span class="pcoded-micon"><i class="ti-angle-right"></i></span>
                            <span class="pcoded-mtext">Group Honor</span>
                            <span class="pcoded-mcaret"></span>
                        </a>
                    </li>
                    <li class="">
            ...
            {{-- <li class="pcoded-hasmenu">
                <a href="javascript:void(0)">
                    <span class="pcoded-micon"><i class="ti-home"></i><b>D</b></span>
                    <span class="pcoded-mtext">Products & Services</span>
                    <span class="pcoded-mcaret"></span>
                </a>
                <ul class="pcoded-submenu">
                    <li class="">
    ...
    <div class="pcoded-inner-navbar main-menu">
        ...
        <ul class="pcoded-item pcoded-left-item">
            ...
            <li class="pcoded-hasmenu">
                <a href="javascript:void(0)">
                    <span class="pcoded-micon"><i class="ti-home"></i><b>D</b></span>
                    <span class="pcoded-mtext">ระบบสมาชิก</span>
                    <span class="pcoded-mcaret"></span>
                </a>
                <ul class="pcoded-submenu">
                    <li class="">
                    ...
                    <li class="">
                        <a href="{{url('/admin/admin')}}">
                            <span class="pcoded-micon"><i class="ti-angle-right"></i></span>
                            <span class="pcoded-mtext">พนักงาน</span>
                            <span class="pcoded-mcaret"></span>
                        </a>
                    </li>
                    ...
                    <li class=" ">
                        <a href="">
                            <span class="pcoded-micon"><i class="ti-angle-right"></i></span>
                            <span class="pcoded-mtext">ตัวแทน</span>
                            <span class="pcoded-mcaret"></span>
                        </a>
                    </li>
            ...
            <li class="pcoded-hasmenu">
                <a href="javascript:void(0)">
                    <span class="pcoded-micon"><i class="ti-home"></i><b>D</b></span>
                    <span class="pcoded-mtext">คลังสินค้า</span>
                    <span class="pcoded-mcaret"></span>
                </a>
                <ul class="pcoded-submenu">
                    <li class="">
                        <a href="#">
                            <span class="pcoded-micon"><i class="ti-angle-right"></i></span>
                            <span class="pcoded-mtext">คลัง</span>
                            <span class="pcoded-mcaret"></span>
                        </a>
                    </li>
                    <li class="">
                        <a href="#">
                            <span class="pcoded-micon"><i class="ti-angle-right"></i></span>
                            <span class="pcoded-mtext">หมวดสินค้า</span>
                            <span class="pcoded-mcaret"></span>
                        </a>
                    </li>
                    ...
                    <li class=" ">
                        <a href="#">
                            <span class="pcoded-micon"><i class="ti-angle-right"></i></span>
                            <span class="pcoded-mtext">รูปแบบลาย</span>
                            <span class="pcoded-mcaret"></span>
                        </a>
                    </li>
                    ...
                    <li class=" ">
                        <a href="#">
                            <span class="pcoded-micon"><i class="ti-angle-right"></i></span>
                            <span class="pcoded-mtext">ฟ้อน</span>
                            <span class="pcoded-mcaret"></span>
                        </a>
                    </li>
                    ...
                    <li class=" ">
                        <a href="#">
                            <span class="pcoded-micon"><i class="ti-angle-right"></i></span>
                            <span class="pcoded-mtext">ประเภทหมึก</span>
                            <span class="pcoded-mcaret"></span>
                        </a>
                    </li>
        ...
        <ul class="pcoded-item pcoded-left-item">
            ...
            <li class="">
                <a href="{{ asset('files/backend/extra-pages/landingpage/index.html') }}" target="_blank">
            ...
            <li class="pcoded-hasmenu ">
                ...
                <ul class="pcoded-submenu">
                    ...
                    <li class="pcoded-hasmenu ">
                        ...
                        <ul class="pcoded-submenu">
                            <li class="">
                                <a href="{{ asset('files/backend/extra-pages/email-templates/email-welcome.html') }}" target="_blank">
                                    <span class="pcoded-micon"><i class="ti-angle-right"></i></span>
                            ...
                            <li class="">
                                <a href="{{ asset('files/backend/extra-pages/email-templates/email-password.html') }}" target="_blank">
                                    <span class="pcoded-micon"><i class="ti-angle-right"></i></span>
                            ...
                            <li class="">
                                <a href="{{ asset('files/backend/extra-pages/email-templates/email-newsletter.html') }}" target="_blank">
                                    <span class="pcoded-micon"><i class="ti-angle-right"></i></span>
                            ...
                            <li class="">
                                <a href="{{ asset('files/backend/extra-pages/email-templates/email-launch.html') }}" target="_blank">
                                    <span class="pcoded-micon"><i class="ti-angle-right"></i></span>
                            ...
                            <li class="">
                                <a href="{{ asset('files/backend/extra-pages/email-templates/email-activation.html') }}" target="_blank">
                                    <span class="pcoded-micon"><i class="ti-angle-right"></i></span>
