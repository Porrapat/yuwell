...
<div class="page-header card">
    <div class="card-block front-icon-breadcrumb">
        <h5 class="m-b-10">Industry Sector</h5>
        <ul class="breadcrumb-title b-t-default p-t-10">
            <li class="breadcrumb-item">
                <a href="#"> <i class="fa fa-home"></i> </a>
            </li>
           
            <li class="breadcrumb-item"><a href="#!">Industry Sector</a>
            </li>
        </ul>
    </div>
</div>
                ...
                <table id="example1" class="table table-bordered">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            {{-- <td><img src="{{url('local/public/'.$item->sector_img)}}" width="100%" alt="no image"></td> --}}

                            <td style="text-align: center; vertical-align: middle;">{!! Str::limit(strip_tags($item->sector_content_th), 35) !!} </td>
                            <td style="text-align: center; vertical-align: middle;">{!! Str::limit(strip_tags($item->sector_content_en), 35) !!}</td>
                            ...
                            <td style="text-align: center; vertical-align: middle;">
                                <div class="row">
                                    &nbsp;&nbsp;
                                    {{-- button Edit --}}
                                    <a href="{{ route('sector.edit',$item->sector_id )}}" class="btn btn-warning waves-effect"
                                        data-target="#Modalupdate"><i class="fa fa-edit"></i></a>
                                    &nbsp;&nbsp;
                                    {{-- button DELETE --}}
                                    <button type="button" class="btn btn-danger" onclick="del({{$item->sector_id }})"><i class="fa fa-trash-o"></i> </button>
                                </div>
    ...
    <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form action="{{route('sector.store')}}" id="main-contractor" method="POST" enctype="multipart/form-data">
                    @csrf
                    ...
                    <div class="col-md-12">
                        ...
                        <div class="form-group">
                            <div class="col-lg-12">
                                <strong>Choose Images Logo</strong>
                                <input class="form-control form-control-sm" type="file" name="sector_logo">
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            <div class="col-lg-12">
                                ...
                                <input class="form-control form-control-sm" type="file" name="sector_img">
                            </div>
                        </div>
                </form>
            </div>
...
<script>
    function del(id) {
        var urlaction = '{{url('admin/sector')}}' + '/' + id;
