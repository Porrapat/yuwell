                    ...
                    <div class="col-md-12">
                            ...
                            <div class="col-md-12">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="serial_number_no" class="form-control" value="{{ $servicereport->service_report_no }}" style="background-color:#ccc" readonly>
                                </div>
                            </div>
                            <div class="col-md-12">
                                <div class="form-group">
                                    <strong>Product Name</strong>
                                    <input type="text" name="serial_number_product_name" class="form-control" value="{{ $servicereport->service_report_product_name }}">
                                </div>
                            </div>
                            <div class="col-md-12">
                                <div class="form-group">
                                    <strong>Type Name</strong>
                                    <input type="text" name="serial_number_type_name" class="form-control" value="{{ $servicereport->service_report_type_name }}">
                                </div>
                            </div>
                            <div class="col-md-12">
                                <div class="form-group">
                                    <strong>Lot</strong>
                                    <input type="text" name="serial_number_lot" class="form-control" value="{{ $servicereport->service_report_lot }}">
                                </div>
                            </div>
                        </div>
                    </div>
